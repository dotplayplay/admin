...
const DetailsTable = () => {
  ...
  return (
    <div id='details-table' className="w-full bg-white shadow-xl rounded-[10px] px-2 py-4 md:p-4">
      <p className="text-[16px] sm:text-md text-slate-600 font-[600] mb-5">Details Table</p>
        ...
        <table className='w-full overflow-x-scroll'>
          ...
          <tbody>
            ...
            <tr key={index}>
              ...
              <td 
                className='text-[.75rem] px-1 md:px-2 py-2 text-center w-max '
              >
                <a href={row.details} className='bg-slate-200 text-[600] px-4 py-2 rounded-[5px] transition duration-150 hover:shadow-md'>Link</a>
              </td>
              <td 
                className='text-[.75rem] text-slate-500 px-1 md:px-2 py-4 text-center w-max '
                >{row.wager}</td>
