...
const CurrencyWallet = ({ currency }) => {
  ...
  return (
    <div id={head[0].id} className="w-full bg-white shadow-xl rounded-[10px] px-2 py-4 md:p-4">
      ...
      <div className="w-full flex justify-end p-2">
        <button className="px-4 border-[1px] rounded-[5px] bg-slate-100" onClick={handleShowDate}>
